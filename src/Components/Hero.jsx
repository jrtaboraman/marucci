      ...
      <div className="my-component-container">
        ...
        <div className="my-component-content">
          ...
          <p className="my-component-description">
            ...
            America is a collaboration of labels and a collective expression of
            love for America that transcends culture, gender, race, age and
            ...
            Volition America is both a symbol and a catalyst for unity when you
            see the VA logo, you are part of a movement that cares. This
            alliance of brands and the consumers who engage with them are making
            a conscious choice to express the power to celebrate America and
